...
//
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        int start_x=Math.floorDiv(drawer.getCol(),2);
        int start_y=Math.floorDiv(drawer.getRow(),2);

        Human human = new Human(start_x, start_y);
        Zombie zombie= new Zombie(30, 50, human);
        ...
        drawer.plotWelcomeScreen(1,1);
        drawer.plotGameLoop(human,zombie,score);
        //plot();
        ...
        while (true) {
            ...
            switch (winner) {
                ...
                case 2:
                    ...
                    //plotEndScreen();
                    score.save();
                    drawer.plotEndScreen(human,1,1);
                    break mainloop;
            }
